...
const EditAdminProfile = () => {
  ...
  useEffect(() => {
    console.log("[v0] EditAdminProfile state:", { loading, error, updateSubmitted })
  ...
  const handleSubmit = (e) => {
    ...
    console.log("[v0] Dispatching updateUser with data:", updateData, "ID:", currentUser._id)
          ...
          <Card className="dashboard-card">
            <Card.Body className="p-4">
              <div className="d-flex justify-content-between align-items-center mb-4">
                ...
                <Button variant="outline-secondary" onClick={() => navigate("/Admin/profile")}>
