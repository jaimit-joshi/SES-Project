...
const deleteTeacher = async (req, res) => {
  try {
    ...
    await Subject.updateOne({ teacher: deletedTeacher._id, teacher: { $exists: true } }, { $unset: { teacher: 1 } })
...
const updateTeacher = async (req, res) => {
  try {
    ...
    const result = await Teacher.findByIdAndUpdate(req.params.id, { $set: req.body }, { new: true })
      .populate("teachSubject", "subName sessions")
      .populate("school", "schoolName")
      .populate("teachSclass", "sclassName")
